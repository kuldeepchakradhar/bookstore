...
public class HomeController {
	...
	public String removeCreditCard(
			@ModelAttribute("id") Long creditCartId, Principal principal, Model model
			)
	{
		User user = userService.findByUsername(principal.getName());
		...
		{
			model.addAttribute("user",user);
			userPaymentService.removeById(creditCartId);
			
			model.addAttribute("listOfCreditCards",true);
			model.addAttribute("classActiveBilliing",true);
	...
	@RequestMapping(value="/setDefaultShipingAddress", method=RequestMethod.POST)
	public String setDefaultShippingAddress(
			@ModelAttribute("userShippingAddressDedaultId") Long defaultShippingId, Principal principal, Model model
			) {
		User user = userService.findByUsername(principal.getName());
	...
	public String setDefaultPayment(
			@ModelAttribute("defaultUserPaymentId") Long defualtPaymentId, Principal principal, Model model
			)
	{
		User user = userService.findByUsername(principal.getName());
		userService.setUserDefaultPayment(defualtPaymentId, user);
	...
	public String updateUserShipping(
			@ModelAttribute("id") Long shippingAddressId, Model model, Principal principal
			)
	{
		User user = userService.findByUsername(principal.getName());
		UserShipping userShipping = userShippingService.findById(shippingAddressId);
